...
<div class="product-info">
    <img src="Imagens/amor.jpg" height="450px" alt="presente">
    <h1>TL$ Amor</h1>
    <h2>R$ 130,00</h2>
    <p>Descrição:</p>
    <p>TL$ Amor carrega o ódio de todos que não foram amados</p>
    <p>transforme seu ódio em amor, obtendo essa peça exclusiva</p>
    <p>da TL$ por apenas R$130,00, muito melhor que a sua alma!</p>
...
<!-- Caixa de Cálculo de Frete -->
<div class="freight-calculator">
    <h4>Calcule o Frete</h4>
    <form id="freightForm">
        <div class="mb-3">
            <label for="cep" class="form-label">Digite seu CEP</label>
            <input type="text" id="cep" class="form-control" placeholder="Exemplo: 12345-678" required>
        </div>
